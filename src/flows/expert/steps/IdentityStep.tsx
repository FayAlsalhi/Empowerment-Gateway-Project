...
/** الخطوة 1: بياناتك — الاسم، البريد، الجوال، المنطقة، ونبذة عنك وخبرتك. */
  ...
  return (
    <form onSubmit={submit} className="flex flex-col gap-6" noValidate>
      <div className="flex flex-col gap-2">
        ...
        <p className="text-sm text-muted-foreground">معلوماتك الأساسية ونبذة عن خبرتك.</p>
      </div>
      ...
      >
        <Textarea
          rows={4}
          placeholder="عرّفنا عن خبرتك ومسيرتك باختصار، وما الذي يمكنك أن تضيفه من خلال خبرتك؟"
          {...register('bio')}
        />
      </FormField>
