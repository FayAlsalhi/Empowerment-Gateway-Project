    ...
    <div className="flex flex-col gap-2">
      ...
      {!hasFile && (
        <div
          ...
          onDrop={onDrop}
          className={cn(
            'flex cursor-pointer flex-col items-center justify-center gap-3 rounded-card border-2 border-dashed px-6 py-10 text-center transition-colors duration-200',
            isDragging ? 'border-accent bg-accent/5' : 'border-border bg-secondary hover:border-accent/50',
      ...
      {hasFile && (
        <div className="flex items-center justify-between gap-3 rounded-card border border-success/30 bg-success/5 px-4 py-3.5">
          ...
          <button
            ...
            onClick={openPicker}
            disabled={uploading}
            className="inline-flex shrink-0 items-center gap-1.5 rounded-lg px-3 py-2 text-xs font-semibold text-accent transition-colors hover:bg-accent/10 disabled:opacity-50"
          >
